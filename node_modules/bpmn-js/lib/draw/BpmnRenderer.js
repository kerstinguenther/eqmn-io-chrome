...
var isValidCondition = require('../../../../app/lib/eq-creator/EventQueryValidator').isValidCondition;
...
function BpmnRenderer(eventBus, styles, pathMap, bpmnRenderer) {
  ...
  function renderConditionLabel(p, label, options, element) {
  	if(window.eventTypes && label && isValidCondition(label, element.incoming[0].source.businessObject.name)) {
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:TextAnnotation': function(p, element) {
      ...
      renderConditionLabel(p, text, { box: element, align: 'left-middle', padding: 5 }, element);
